...
import crosswords from "~/marzofka-crosswords.json";
...
export default function MarzofkaCrosswordPage({
  params,
}: {
        ...
        <div className="max-w-lg text-center">
          ...
          <div className="mb-8 flex justify-center gap-1.5 sm:gap-2">
            {secretWord.split("").map((letter, i) => (
              <span
                key={i}
                className="animate-reveal inline-block rounded-lg bg-yellow-200 px-2 py-2 text-2xl font-extrabold tracking-widest text-green-900 sm:px-3 sm:py-3 sm:text-3xl"
